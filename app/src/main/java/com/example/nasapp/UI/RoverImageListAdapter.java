...
/*TODO: Copy from Project -> GridToPager ; Files -> GridFragment, GridAdapter, ImagePagerFragment.*/
...
public class RoverImageListAdapter extends RecyclerView.Adapter<RoverImageListAdapter.ViewHolder> {
    ...
    public RoverImageListAdapter(Context context, Rover rover, InteractionListener listener, Fragment fragment) {
        this.rover = rover;
